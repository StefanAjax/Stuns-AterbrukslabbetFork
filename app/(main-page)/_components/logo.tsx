...
const ThemedLogo: React.FC<ThemedLogoProps> = ({ className = "", variant = "default", customColor, width = 100, height = 100 }) => {
  const colorSchemes = {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 734.89 800" className={className} width={width} height={height} aria-label="Logo">
      <path fill={color} d="M188.72,21.93c0-12.06,9.87-21.93,21.93-21.93h312.5c12.06,0,21.93,9.87,21.93,21.93v9.87c0,12.06-9.87,21.93-21.93,21.93H210.65c-12.06,0-21.93-9.87-21.93-21.93v-9.87Z" />
      <path
        fill={color}
      ...
      <path
        fill={color}
        d="M620.84,459.1l-68.31-105.15c-26.29-40.45-47.69-73.38-66.67-99.44V53.73h-58.11v222.59l37.82,58.26c9.18,13.71,19.09,29,30.06,45.91l83.44,128.62c67.87,104.61,101.75,156.8,79.93,196.93-21.82,40.13-84.1,40.13-208.77,40.13h-166.78c-124.67,0-186.95,0-208.77-40.13-21.82-40.13,12.17-92.43,79.93-196.93l83.55-128.62c11.02-16.99,20.98-32.36,30.19-46.12l38.78-59.73V53.73h-59.21v202.25c-18.7,25.82-39.78,58.28-65.57,97.97l-68.31,105.15C31.26,586.51-10.08,650.22,2.09,702.52c5.15,22.15,16.23,42.43,31.91,58.77c37.28,38.71,113.16,38.71,265.13,38.71h136.62c151.97,0,227.96,0,265.13-38.71,15.68-16.34,26.75-36.62,31.91-58.77,12.17-52.3-29.17-116.01-111.95-243.42Z"
      />
    </svg>
  );
};
