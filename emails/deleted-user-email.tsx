  ...
  return (
    <EmailTemplate
      ...
      main={
        <>
          <Text>
            Detta kan bero på att du har uppfört dig olämpligt på sidan och/eller brutit våra regler. Om du tror att det har skett ett fel och inte känner igen detta kan du höra av dig till oss.
          </Text>
